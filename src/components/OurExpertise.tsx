...
import { imageSize } from '@/utils/commonClasses';
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <Image src={WebAppImage1} alt="web apps image" className={clsx(imageSize, 'py-20 md:py-32')} />
        <p>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <Image src={WebAppImage2} alt="web solutions image" className={clsx(imageSize, 'py-20 md:py-32')} />
        <p>
