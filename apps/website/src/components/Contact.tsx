...
const Contact = () => {
  ...
  return open ? (
    ...
    >
      {isSuccess ? (
        <div className="inline-flex w-11/12 md:w-2/3 max-w-screen-xl h-4/5 rounded-3xl bg-white items-center justify-center [&>svg]:m-0">
          <Checkmark />
          <div className={clsx(poppins.className, 'font-semibold text-3xl text-grey-11 pl-10')}>
        ...
        <div className="flex w-11/12 md:w-2/3 max-w-screen-xl h-4/5 rounded-3xl bg-white relative flex-wrap">
          <div className="absolute right-8 top-5 w-5" onClick={toggle}>
            <Image
              ...
              className="w-full aspect-square hover:opacity-70 cursor-pointer"
            />
          </div>
